...
class AnimationDrawer:
    ...
    def create_grid_lines(self, grid_holder: GridHolder, render_width, render_height):
        cfg, r = self.svg_settings, grid_holder.obs_radius
        offset = 0
    ...
    def create_animation(self, grid_holder, animation_config: AnimationConfig = None):
        """
        ...
        # grid: Grid = grid
        self.svg_settings = cfg = AnimationSettings()
        ...
        drawing = Drawing(width=render_width, height=render_height, svg_settings=AnimationSettings(),
                          origin=[0, 0])
    ...
    def create_field_of_view(self, grid_holder, animation_config):
        ...
        dr = (grid_holder.obs_radius + 1) * cfg.scale_size - cfg.stroke_width * 2
